...
export const ContactUsPage = () => {
  return (
    <div className="lg:h-full grid grid-cols-1 lg:grid-cols-2 mb-5 pb-20">
      <div className="px-5 pt-20 lg:p-20 flex items-center relative">
        <div className=" relative">
          <motion.div
            ...
            className="absolute w-full h-full bg-gradient-to-r from-blue-100 to-blue-800 top-[-20%] left-[-10%] rounded-tl-[30rem] rounded-bl-[10rem] z-0 lg:w-[120%] lg:h-[150%]"
          ></motion.div>

          <motion.div
            initial={{ opacity: 0, y: 50 }} // Adjust y for mobile responsiveness
