  ...
  return (
    ...
    <div className="w-full max-w-screen-lg mx-auto p-4 lg:p-8 rounded-2xl border border-designColor bg-background">
      ...
      <div className="flex flex-wrap gap-4 justify-center">
        <div className="bg-transparent w-32 h-12 flex items-center justify-center rounded-lg shadow-sm border border-b-gray-500 hover:bg-primary" onClick={handleProfile}>
